...
class TestModel(unittest.TestCase):
    ...
    def test_check_validity(self):
        ...
        self.assertFalse(self.model.check_validity(["10-09-2015", "12", 10]))
    ...
    def test_find_by_date(self):
        elemennts = [model.Model.Record("12-01-2017", 125, 3.14), model.Model.Record("12-03-2017", 250, 14.20), \
                     model.Model.Record("12-03-2017", 456, 55.11)]
        self.assertEqual(self.model.find_by_date(elemennts, "12-03-2017")[0].length, 250)
